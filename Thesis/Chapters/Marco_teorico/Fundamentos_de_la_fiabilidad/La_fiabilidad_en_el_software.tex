...
por el medio ambiente. El \ac{SW} es determinístico, siempre responde de la misma manera en el mismo ambiente, a menos que falle.
...
definiciones, pero comúnmente es expresado como la probabilidad de \textbf{no fallar}
...
La confiabilidad es la probabilidad de que un sistema continue operando correctamente durante un
